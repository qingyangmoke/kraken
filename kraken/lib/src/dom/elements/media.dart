...
final Pointer<NativeFunction<Native_PlayMedia>> nativePlay =
    Pointer.fromFunction(MediaElement._play);
final Pointer<NativeFunction<Native_PauseMedia>> nativePause =
    Pointer.fromFunction(MediaElement._pause);
final Pointer<NativeFunction<Native_FastSeek>> nativeFastSeek =
    Pointer.fromFunction(MediaElement._fastSeek);

abstract class MediaElement extends Element {
  static SplayTreeMap<int, MediaElement> _nativeMap = SplayTreeMap();

  static MediaElement getMediaElementOfNativePtr(
    ...
    assert(mediaElement != null,
        'Can not get mediaElement from nativeElement: $nativeMediaElement');
    return mediaElement;
  }
  ...
  static void _fastSeek(
      Pointer<NativeMediaElement> nativeMediaElement, double duration) {
    MediaElement mediaElement = getMediaElementOfNativePtr(nativeMediaElement);
  ...
  MediaElement(int targetId, 
      this.nativeMediaElementPtr,
      ElementManager elementManager, 
      String tagName,
      {Map<String, dynamic> defaultStyle})
      : super(targetId, 
            nativeMediaElementPtr.ref.nativeElement, 
            elementManager,
            isIntrinsicBox: true,
            tagName: tagName,
            repaintSelf: true,
